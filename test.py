# -*- coding: utf-8 -*-
"""
Created on Fri Nov  9 13:17:29 2018
...
def game(net):
    ...
    while running:
        ...
        for mb in mobs:
            if mb.rect.right in range(player.rect.left-20,player.rect.right+20):
                inp[0] = 1
                act = "left"
            if mb.rect.left in range(player.rect.left-20,player.rect.right+20):
                inp[1] = 1
                act = "right"
...
genomeFile = 'D:/NEAT/Shmup/bestGenomes/model0.06347222222222222.sav'
